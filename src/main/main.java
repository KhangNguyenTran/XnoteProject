...
public class main {
	...
	private JMenuItem pmNewTab;
	private JMenuItem pmSaveFile;
	private JMenuItem pmOpenFile;
	private JMenuItem pmCloseTab;
	private JMenuItem pmCloseAll;
	private JMenuItem pmExit;
	...
	private void initialize() {
		...
		mntmAbout.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (aboutDialog == null) {
					Window topWindow = SwingUtilities.getWindowAncestor(tabbedPane);
					aboutDialog = new JDialog(topWindow, "About", ModalityType.MODELESS);
					aboutDialog.getContentPane().add(new AboutDialogPanel().getMainPanel());
					aboutDialog.setLocationRelativeTo(topWindow);
