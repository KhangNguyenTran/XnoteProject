...
public class FontChooser extends JComponent
{
    ...
    private JTextPane fontFamilyTextField = null;
    private JTextPane fontStyleTextField = null;
    private JTextPane fontSizeTextField = null;
    ...
    public JTextPane getFontFamilyTextField()
    {
        if (fontFamilyTextField == null)
        {
            fontFamilyTextField = new JTextPane();
    ...
    public JTextPane getFontStyleTextField()
    {
        if (fontStyleTextField == null)
        {
            fontStyleTextField = new JTextPane();
    ...
    public JTextPane getFontSizeTextField()
    {
        if (fontSizeTextField == null)
        {
            fontSizeTextField = new JTextPane();
    ...
    protected JTextPane getSampleTextField()
    {
        if (sampleText == null)
        {
            ...
            sampleText.setEditorKit(new CenteredEditorKit());
            SimpleAttributeSet center = new SimpleAttributeSet();
            StyleConstants.setAlignment(center, StyleConstants.ALIGN_CENTER);
            StyledDocument doc = sampleText.getStyledDocument();
